...
def get_user_choice(prompt="请输入选项: "):
    """获取用户输入的选项
            ...
            if files:
                ...
                try:
                    ...
                    if 0 <= file_index < len(files):
                        ...
                        display_result(result['success'], f"文件复制成功，新文件ID: {result['file_id']}" if result['success'] else f"文件复制失败: {result['message']}")
                    else:
                        print("无效的文件序号")
                except ValueError:
                    print("请输入有效的数字")
            ...
            if files:
                ...
                try:
                    ...
                    if 0 <= file_index < len(files):
                        ...
                        display_result(result['success'], "文件重命名成功" if result['success'] else f"文件重命名失败: {result['message']}")
                    else:
                        print("无效的文件序号")
                except ValueError:
                    print("请输入有效的数字")
            ...
            if files:
                ...
                try:
                    ...
                    if 0 <= file_index < len(files):
                        ...
                        display_result(result['success'], "文件删除成功" if result['success'] else f"文件删除失败: {result['message']}")
                    else:
                        print("无效的文件序号")
                except ValueError:
                    print("请输入有效的数字")
            ...
            if files:
                ...
                try:
                    ...
                    if 0 <= file_index < len(files):
                        ...
                        display_result(result['success'], f"文件导出成功: {result['export_path']}" if result['success'] else f"文件导出失败: {result['message']}")
                    else:
                        print("无效的文件序号")
                except ValueError:
                    print("请输入有效的数字")
...
def tag_menu(tag_manager, file_manager):
    ...
    while True:
        ...
        if choice == '1':
            ...
            display_result(result['success'], "标签添加成功" if result['success'] else f"标签添加失败: {result['message']}")
            wait_for_enter()
            ...
            if tags:
                ...
                try:
                    ...
                    if 0 <= tag_index < len(tags):
                        ...
                        display_result(result['success'], "标签删除成功" if result['success'] else f"标签删除失败: {result['message']}")
                    else:
                        print("无效的标签序号")
                except ValueError:
                    print("请输入有效的数字")
                        ...
                        if tags:
                            ...
                            try:
                                ...
                                if 0 <= tag_index < len(tags):
                                    ...
                                    display_result(result['success'], "标签移除成功" if result['success'] else f"标签移除失败: {result['message']}")
                                else:
                                    print("无效的标签序号")
                            except ValueError:
                                print("请输入有效的数字")
